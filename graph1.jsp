...
<!-- end of top panel -->
  ...
  <div id="templatemo_content"> 
    <div class="content_title_1"><font color="#000066"><strong><u>  	Dynamic Resource Graph Modulation</u></strong></font></div>
    <fieldset style="border: 5px solid #000000 ;
border-radius: 10px ;
-moz-border-radius: 10px ;
-webkit-border-radius: 10px ; width:160px;  margin: 0px 0px;">
    <br></font>
  <table><td width="200"></td><td><img src="c://logotype.jpg"></td></table>
