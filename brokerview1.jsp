...
<!-- end of top panel -->
  ...
  <div id="templatemo_content"> 
    <div class="content_title_1"><font color="#FF0000"><strong><u>Check User Price 
    ...
    <table width="943" >
      <tr bgcolor="#CCCCCC"> 
        ...
        <td width="111"><font color="#000000"><strong>Package</strong></font></td>
        <td width="111"><font color="#000000"><strong>Cost</strong></font></td>
...
String sql="select * from fileup where brokerstatus='Accept' and serverstatus='Processing'";
...
while(rs.next())
  ...
  %>
      <tr> 
        ...
        <td ><a href="sendserver.jsp?fid1=<%=rs.getString("fid")%>"><font color="#FFFF00"><strong> 
          SendToCloudServer</strong></font></a></td>
      </tr>
      <%
