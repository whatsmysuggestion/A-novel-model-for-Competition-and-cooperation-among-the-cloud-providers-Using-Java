...
<!-- end of top panel -->
  ...
  <div id="templatemo_content"> 
    <div class="content_title_1"><font color="#000066"><strong><u>View Upload 
      Data Status </u></strong></font></div>
    <table width="943" >
      <tr bgcolor="#FF6600"> 
        ...
        <td width="87"><font color="#000000"><strong>Size</strong></font></td>
        ...
        <td width="111"><font color="#000000"><strong>Check Offer</strong></font></td>
      </tr>
      <br>
      <% 
...
String sql="select * from fileup where uname='"+a+"'";
...
while(rs.next())
  ...
  %>
      <tr> 
        ...
        <td align="center"> <font color="#000066"> <strong> 
          <%=rs.getString("size")%>
          KB </strong> </font> </td>
        ...
        <td ><a href="offerstatus.jsp?fid1=<%=rs.getString("fid")%>"><font color="#FFFF00"><strong> 
          View Publish Offer</strong></font></a></td>
      </tr>
      <%
