...
<!-- end of top panel -->
  ...
  <div id="templatemo_content"> 
    <div id="content_left"> 
      ...
      <img src="images/c1.png" width="250" height="250"> 
    ...
    <div id="content_right"> 
      <div class="content_title_1"><font color="#000066"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <u>Broker Login Form:</u></strong></font></div>
      <div align="center"> 
        <form method="get" name="form" action="brokerlgin1.jsp" onSubmit="return validation()">
