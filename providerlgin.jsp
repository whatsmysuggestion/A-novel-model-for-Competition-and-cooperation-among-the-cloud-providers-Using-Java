...
var t=document.form.usertype.value;
...
if(document.form.usertype.selectedIndex==0)
{
...
<!-- end of top panel -->
    ...
    <div id="templatemo_menu">
        ...
        <ul>
            ...
            <li><a href="providerlgin.jsp"  class="current">Service Provider</a></li>
  ...
  <div id="templatemo_content"> 
    <div id="content_left"> 
      ...
      <img src="images/a8.jpeg" width="250" height="250"> 
    ...
    <div id="content_right"> 
      <div class="content_title_1"><font color="#0033CC" size="+1"><strong><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>Service 
        Provider Login Form:</u></strong></strong></font></div>
      <div align="center"> 
        <form method="get" name="form" action="providerlgin1.jsp" onSubmit="return validation()">
          <table width="509" height="227" bordercolor="#000000">
            <tr> 
              <td width="120" height="54"><strong><font color="#000000">User Name</font></strong></td>
              <td width="377"><input type="text" name="uname"></td>
            </tr>
            <tr> 
              <td height="51"><strong><font color="#000000" >Pass Word</font></strong></td>
              <td><input type="password" name="pwd"></td>
            </tr>
            <tr> 
              <td><font color="#000000"><strong><strong>User Type</strong></strong></font></td>
              <td><select name="usertype">
                  <option value>----select usertype----</option>
                  <option value="serviceprovider1">service provider1</option>
                  <option value="serviceprovider2">service provider2</option>
                  <option value="serviceprovider3">service provider3</option>
                </select> </td>
            </tr>
            <tr> 
              <td></td>
